...
class LatticeGNN(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.radial_embedding = RadialEmbeddingBlock(3, 8, 4)
        ...
        edge_attr_irreps = o3.Irreps.spherical_harmonics(lmax=3)
        ...
        readout_irreps = o3.Irreps('32x0e+32x1o+32x2e')
        ...
        self.pooling = GlobalSumHistoryPooling(reduce='sum')
    ...
    def configure_optimizers(self) -> torch.Tensor:
        optimizer = torch.optim.AdamW(self.parameters(), lr=0.001, amsgrad=True)
