...
new_cat_name = f'E:/Dropbox (Cambridge University)/neural-networks/GLAMM/mon_06-03-2023/normals_cat_{num_cat}.lat'
new_cat_dict = dict()
...
# for lat_data in tqdm(cat):
    ...
    for imperfection_level in imp_levels:
        ...
        for i_imperf in range(num_imperf):
            ...
            lat_imp.name = lat_imp.name + f'_p_{imperfection_level}'
            ...
            # lat_mesh = lat_imp.refine_mesh(1, 3)
