...
from gnn.mace import get_edge_vectors_and_lengths, reshape_irreps
...
class GNN_Head(torch.nn.Module):
    def __init__(self, params: Namespace) -> "GNN_Head":
        ...
        # self.linear_skip = torch.nn.ModuleList([ # don't need linear skip, because first layer inside Interaction is a Linear layer
