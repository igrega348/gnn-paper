...
new_cat_name = f'C:/temp/gnn-paper-newdata/imperf_cat_{num_cat}.lat'
new_cat_dict = dict()

job_num = 0

with tarfile.open(f'C:/temp/gnn-paper-newdata/input_files_cat_{num_cat}.tar.gz', 'w:gz') as archive:
