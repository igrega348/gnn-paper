...
new_cat_name = f'E:/Dropbox (Cambridge University)/neural-networks/GLAMM/mon_06-03-2023/imperf_cat_{num_cat}_new.lat'
new_cat_dict = dict()

job_num = 300001

with tarfile.open(f'E:/Dropbox (Cambridge University)/neural-networks/GLAMM/mon_06-03-2023/input_files_cat_{num_cat}_new.tar.gz', 'w:gz') as archive:
    ...
    # for lat_data in tqdm(cat):
        ...
        lat_data.pop('fundamental_edge_adjacency')
        lat_data.pop('fundamental_tesselation_vecs')
